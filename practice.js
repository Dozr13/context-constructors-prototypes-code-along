...
// Code here
let username1 = getUsername.call(user1)
let username2 = getUsername.call(user2)
...
Person.prototype.removeFriend = function(un){
  this.friends.splice(this.friends.indexOf(un), 1)
}
...
User.prototype.changePostRating = function(id, num){
  this.savedPosts[this.savedPosts.findIndex(i => i.id === id)].rating = num
}